        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?= base_url('assets') ?>/assets/img/aurospace.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
                ...
                <div class="row sm-gutters">
                  <div class="col-6">
                    <a href="" class="btn-social">
                      <i class="fa-brands fa-facebook text-light" style="font-size: 24px;"></i> Facebook
                    </a>
                  </div>
                  <div class="col-6">
                    <a href="" class="btn-social">
                      <i class="fa-brands fa-twitter text-light" style="font-size: 24px;"></i> Twitter
                    </a>
                  </div>
                </div>
